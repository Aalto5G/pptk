                                             ...
                                             int num)
{
  ...
  while (i != new_end)
  {
    ...
    tx_mbufs[j++] = indpdkq->pkts_all[i];
    i++;
    if (i >= indpdkq->num_bufs)
    {
      i = 0;
    }
  }
  ...
  {
    indpdkq->buf_end += ret;
    if (indpdkq->buf_end >= indpdkq->num_bufs)
    {
      indpdkq->buf_end -= indpdkq->num_bufs;
    }
  }
  return ret;
}
