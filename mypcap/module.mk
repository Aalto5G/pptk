MYPCAP_SRC_LIB := mypcap.c
MYPCAP_SRC := $(MYPCAP_SRC_LIB) testpcap.c
...
MYPCAP: $(DIRMYPCAP)/libmypcap.a $(DIRMYPCAP)/testpcap
...
$(DIRMYPCAP)/testpcap: $(DIRMYPCAP)/testpcap.o $(DIRMYPCAP)/libmypcap.a $(MAKEFILES_COMMON) $(MAKEFILES_MYPCAP)
...
distclean_MYPCAP: clean_MYPCAP
	rm -f $(DIRMYPCAP)/libmypcap.a $(DIRMYPCAP)/testpcap
