...
TIMERSKIPLIST: $(DIRTIMERSKIPLIST)/libtimerlinkheap.a $(DIRTIMERSKIPLIST)/timertest $(DIRTIMERSKIPLIST)/timertest2

unit_TIMERSKIPLIST:
	@true

$(DIRTIMERSKIPLIST)/libtimerlinkheap.a: $(TIMERSKIPLIST_OBJ_LIB) $(MAKEFILES_COMMON) $(MAKEFILES_TIMERSKIPLIST)
	rm -f $@
	ar rvs $@ $(filter %.o,$^)

$(DIRTIMERSKIPLIST)/timertest: $(DIRTIMERSKIPLIST)/timertest.o $(DIRTIMERSKIPLIST)/libtimerlinkheap.a $(LIBS_TIMERSKIPLIST) $(MAKEFILES_COMMON) $(MAKEFILES_TIMERSKIPLIST)
	$(CC) $(CFLAGS) -o $@ $(filter %.o,$^) $(filter %.a,$^) $(CFLAGS_TIMERSKIPLIST)

$(DIRTIMERSKIPLIST)/timertest2: $(DIRTIMERSKIPLIST)/timertest2.o $(DIRTIMERSKIPLIST)/libtimerlinkheap.a $(LIBS_TIMERSKIPLIST) $(MAKEFILES_COMMON) $(MAKEFILES_TIMERSKIPLIST)
	$(CC) $(CFLAGS) -o $@ $(filter %.o,$^) $(filter %.a,$^) $(CFLAGS_TIMERSKIPLIST)
...
distclean_TIMERSKIPLIST: clean_TIMERSKIPLIST
	rm -f $(DIRTIMERSKIPLIST)/libtimerlinkheap.a $(DIRTIMERSKIPLIST)/timertest $(DIRTIMERSKIPLIST)/timertest2
