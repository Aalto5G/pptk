...
CFLAGS_PORTS := -I$(DIRHASHLIST) -I$(DIRMISC) -I$(DIRPACKET) -I$(DIRLINKEDLIST) -I$(DIRALLOC) -I$(DIRMYPCAP) -I$(DIRDYNARR) -I$(DIRHASHTABLE) -I$(DIRLOG) -I$(DIRLDP) -I$(DIRNETMAP) -I$(DIRRBTREE)
ifeq ($(WITH_NETMAP),yes)
CFLAGS_PORTS += -I$(NETMAP_INCDIR) -Wno-sign-conversion
endif
ifeq ($(WITH_ODP),yes)
